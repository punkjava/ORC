...
$sql=mysqli_query($con,"SELECT password FROM  student_login where password='$oldpass'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update student_login set password='$newpassword' where password='$oldpass'");
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li  class="active"><a href="stud_chgpsw.php">Change Password</a></li>
